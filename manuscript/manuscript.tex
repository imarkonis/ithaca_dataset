...
Terrestrial water-cycle data are essential for our understanding of atmospheric and land-surface interactions as water circulates between them. Precipitation, evapotranspiration, and their balance, precipitation minus evapotranspiration (P-E), constitute the core of myriad research endeavors, from drought and flood assessment to water stress, food security,  and the attribution of water cycle responses to climate change. However, existing estimates of precipitation and evapotranspiration often vary significantly due to several factors, including the density of observational networks, data retrieval algorithms, model assumptions, bias-correction methods, point-to-grid transformations, and missing-data handling, among others. Even minor inconsistencies among precipitation, evapotranspiration, and, consequently, P-E, however small, may propagate into large differences in downstream analyses and even lead researchers into contradicting findings.
